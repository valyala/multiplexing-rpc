...
static enum ff_result write_char_array_param_to_stream(const struct mrpc_param *param, struct ff_stream *stream)
{
	struct char_array_param *char_array_param;
	enum ff_result result;
...
static void get_char_array_param_value(const struct mrpc_param *param, void **value)
{
	struct char_array_param *char_array_param;
