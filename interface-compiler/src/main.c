...
void help(char *app_name)
{
	...
	printf(
		...
		"    - client_{interface_name}.h contains declarations of rpc\n"
		"      wrapper functions defined in the interface definition file.\n"
		"      These functions must be called in order to perform rpc.\n"
		"\n"
		"    - client_{interface_name}.c contains definition of\n"
		"      the rpc wrapper functions. Do not modify this file!\n"
		"\n"
		"    - distributed_client_{interface_name}.h contains declarations\n"
		"      of rpc wrapper functions defined in the interface definition file,\n"
		"      which must be called to perform distributed rpc.\n"
		"\n"
		"    - distributed_client_{interface_name}.c constains definition of\n"
		"      the rpc wrapper functions for distributed client.\n"
		"      Do not modify this file!\n"
		"\n"
		"  - c_server - generates server source files for the C mrpc library:\n"
		"    - server_stream_handler_{interface_name}.h contains single declaration\n"
		"      of the mrpc_server_stream_handler, which implements the interface\n"
		"      defined in the interface definition file.\n"
		"\n"
		"    - server_stream_handler_{interface_name}.c contains definition\n"
		"      of the mrpc_server_stream_handler. Do not modify this file!\n"
		"\n"
		"    - service_{interface_name}.h contains declaration of the service,\n"
		"      which must implement rpc interface defined in the interface definition\n"
		"      file on the server.\n"
		"\n"
		"    - service_{interface_name}.c contains stubs for the service,\n"
